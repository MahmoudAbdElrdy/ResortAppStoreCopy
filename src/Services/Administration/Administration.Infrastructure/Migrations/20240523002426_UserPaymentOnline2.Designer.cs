...
namespace ResortAppStore.Services.Administration.Infrastructure.Migrations
{
    ...
    [Migration("20240523002426_UserPaymentOnline2")]
    partial class UserPaymentOnline2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResortAppStore.Services.Administration.Domain.Entities.Auth.PackageModuleCompany", b =>
                {
                    ...
                    b.Property<long?>("ModuleUserDetailsId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ResortAppStore.Services.Administration.Domain.Entities.Auth.UserCompany", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ResortAppStore.Services.Administration.Domain.Entities.Auth.UserPaymentOnline", b =>
                {
                    ...
                    b.Property<string>("CartCurrencyCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CartDecription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ResortAppStore.Services.Administration.Domain.Entities.Auth.UserSubscriptionPromoCode", b =>
                {
                    ...
                    b.HasIndex("ModuleUserDetailsId");
            ...
            modelBuilder.Entity("ResortAppStore.Services.Administration.Domain.Entities.Auth.UserSubscriptionPromoCode", b =>
                {
                    b.HasOne("ResortAppStore.Services.Administration.Domain.Entities.Auth.UserDetailsModule", "UserDetailsModule")
                        .WithMany("UserSubscriptionPromoCodes")
                        .HasForeignKey("ModuleUserDetailsId");
                    ...
                    b.Navigation("UserDetailsModule");
