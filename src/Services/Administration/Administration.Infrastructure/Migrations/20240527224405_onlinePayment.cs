    ...
    public partial class onlinePayment : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashPaymentInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PackageModuleCompanies",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PackageUserDetailsId = table.Column<long>(type: "bigint", nullable: true),
                    ModuleUserDetailsCode = table.Column<long>(type: "bigint", nullable: true),
                    CompanyId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageModuleCompanies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullBuyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAr = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    NameEn = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    PromoCode = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "UserDetailsPackagesModules",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserDetailsModuleId = table.Column<long>(type: "bigint", nullable: false),
                    UserDetailsPackageId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDetailsPackagesModules", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "UserOrgnizations",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrganizationNameAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrganizationNameEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DatabaseName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DomainName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrgnizations", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "UserOrgnizationTypes",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrgnizationTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserPackageId = table.Column<long>(type: "bigint", nullable: true),
                    UserModuleCode = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerifyCode = table.Column<bool>(type: "bit", nullable: true),
                    VerifyCode = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDetailsModule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDetailsModule_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackagesModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackagesModules_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackagesModules_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDetailsPackage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDetailsPackage_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerSubscription_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                name: "UserSubscriptionPromoCodes",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    UserDetailsModuleId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSubscriptionPromoCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSubscriptionPromoCodes_PromoCodes_PromoCodeId",
                        column: x => x.PromoCodeId,
                        principalTable: "PromoCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSubscriptionPromoCodes_UserDetailsModule_UserDetailsModuleId",
                        column: x => x.UserDetailsModuleId,
                        principalTable: "UserDetailsModule",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserSubscriptionPromoCodes_UserDetailsPackage_PackageUserDetailsId",
                        column: x => x.PackageUserDetailsId,
                        principalTable: "UserDetailsPackage",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackagesModules_ModuleId",
                table: "PackagesModules",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_PackagesModules_PackageId",
                table: "PackagesModules",
                column: "PackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDetailsModule_ModuleId",
                table: "UserDetailsModule",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserDetailsPackage_PackageId",
                table: "UserDetailsPackage",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptionPromoCodes_PackageUserDetailsId",
                table: "UserSubscriptionPromoCodes",
                column: "PackageUserDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptionPromoCodes_PromoCodeId",
                table: "UserSubscriptionPromoCodes",
                column: "PromoCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptionPromoCodes_UserDetailsModuleId",
                table: "UserSubscriptionPromoCodes",
                column: "UserDetailsModuleId");
        }
