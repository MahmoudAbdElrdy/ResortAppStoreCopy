...
{
    /// <inheritdoc />
    public partial class update_Accounting_period : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(
                name: "CloseAccountingPeriods");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountingPeriods_FiscalPeriods_FiscalPeriodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountingPeriods_FiscalPeriodId",
                table: "AccountingPeriods",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CloseAccountingPeriods", x => x.Id);
                });
        }
    }
}
