...
{
    /// <inheritdoc />
    public partial class add_POSBillPaymentDetail : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillPaymentDetails_Bills_BillId",
                        column: x => x.BillId,
                        principalTable: "Bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillPaymentDetails_PaymentMethods_PaymentMethodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillPaymentDetails_PaymentMethodId",
                table: "BillPaymentDetails",
