...
namespace ResortAppStore.Services.ERPBackEnd.Infrastructure.Migrations
{
    ...
    [Migration("20240123084300_add_ManualInventoryApproval")]
    partial class add_ManualInventoryApproval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResortAppStore.Services.ERPBackEnd.Domain.Warehouses.ManualInventoryApproval", b =>
                {
                    b.HasOne("ResortAppStore.Services.ERPBackEnd.Domain.Warehouses.Bill", "InputBill")
                        .WithMany()
                        .HasForeignKey("InputBillId");

                    b.HasOne("ResortAppStore.Services.ERPBackEnd.Domain.Warehouses.Bill", "OutputBill")
                        .WithMany()
                        .HasForeignKey("OutputBillId");
