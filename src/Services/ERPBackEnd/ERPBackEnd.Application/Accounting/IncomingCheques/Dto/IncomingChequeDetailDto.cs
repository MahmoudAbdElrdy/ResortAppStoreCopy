...
{
    public class IncomingChequeDetailDto :IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<IncomingChequeDetailDto, IncomingChequeDetail>()
                .ReverseMap();
            configuration.CreateMap<IncomingChequeDetail, IncomingChequeDetailDto>().ReverseMap();
