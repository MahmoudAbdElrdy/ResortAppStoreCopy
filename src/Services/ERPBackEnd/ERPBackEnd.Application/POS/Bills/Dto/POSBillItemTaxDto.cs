...
{
    public class POSBillItemTaxDto : IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<POSBillItemTaxDto, POSBillItemTax>()
                .ReverseMap();
            configuration.CreateMap<POSBillItemTax, POSBillItemTaxDto>().ReverseMap();
